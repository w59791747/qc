	...
	<div class="zx_list_wrap">
		<div class="zx_list_l">
			<ul>
				 ...
				 <li><a class="cur_zx_list" href="<?php echo U('cheshang/index');?>">合作车商</a></li>
			</ul>
		</div>
		<div class="zx_list_r">
		<div class="huodong">
				...
				<ul>
					<?php if(is_array($list2)): foreach($list2 as $key=>$item): ?><li><a  href=""><img src="__ATTACHS__/<?php echo ($item["img"]); ?>" alt="<?php echo ($item["title"]); ?>" /><span><?php echo ($item["title"]); ?></span></a></li><?php endforeach; endif; ?>
				</ul>

			</div>
        	
			<div class="select_page zx_list_page"><?php echo ($page); ?></div>
		</div>
