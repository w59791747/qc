...
<div class="help_list">
  <ul>
   <?php if(is_array($list2)): foreach($list2 as $key=>$item): ?><li>
     		<a href=""><img src="__ATTACHS__/<?php echo ($item["img"]); ?>" alt="<?php echo ($item["title"]); ?>" /><span><?php echo ($item["title"]); ?></span></a>
