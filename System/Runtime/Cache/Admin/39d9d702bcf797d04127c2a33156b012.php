...
<div class="pad">
          <div class="breadNav">
            ...
            <span>会员</span><i></i><span>会员日志</span><i></i><span>短信日志</span>
             ...
             <div class="daemonTable">
              <table class="table_data daemon_data" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <th >内容</th>
                    <th class="w-50">状态</th>
                    <th class="w-200">发送时间</th>
                    
                </tr>
                    <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                            <td><?php echo ($var["log_id"]); ?></td>
                            <td><?php echo ($var["mobile"]); ?></td>
                            <td class="wsNormal"><?php echo ($var["content"]); ?></td>
                            <td><?php if($var["status"] == 1): ?><span class="green">[成功]<?php else: ?><span class="red">[失败]</span><?php endif; ?></td>
