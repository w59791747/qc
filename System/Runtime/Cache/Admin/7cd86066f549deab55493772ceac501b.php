...
<div class="pad">
  <div class="breadNav">
    <div class="flt breadNav_text"> <span>会员</span><i></i><span>会员日志</span><i></i><span>积分日志</span> </div>
    <div class="frt breadNav_other">
      <div class="bn_input theme-pop-btn">
        <form method="post" action="<?php echo U('memberlog/index');?>">
  ...
  <div class="daemonTable">
    <table class="table_data daemon_data" cellpadding="0" cellspacing="0">
      ...
      <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
          ...
          <td class="wsNormal"><?php echo ($var["log"]); ?></td>
