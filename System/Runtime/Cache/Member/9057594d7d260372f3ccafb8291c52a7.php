...
<div class="uc_mid_r yitou_list">
			<ul class="cz_tit">
				<li><a href="<?php echo U('member/set/index');?>">修改资料</a></li>
				...
				<li class="cz_cur"><a href="<?php echo U('member/set/adress');?>">收货地址</a></li>
			</ul>
			<div class="select_yitou">
				<a href="<?php echo U('set/adresscreate');?>" class="queding yhk">+ 新建收货地址</a>
			</div>
             <?php if($list): ?><table width="100%" border="0" cellspacing="0" cellpadding="0">
				 <tbody>
					...
					<?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                            ...
                            <td><span class="ad_text"><?php echo ($var["city"]); echo ($var["addr"]); ?></span><div>详细地址：<?php echo ($var["city"]); ?> <?php echo ($var["addr"]); ?></div></td>
                            <td><?php echo ($var["phone"]); ?></td>
                            <td><?php echo (date("Y-m-d",$var["dateline"])); ?></td>
                            <td style="text-align:left">
                            <?php if($var["default"] != 1): ?><a target="chuang_frm" class="gozf" href="<?php echo U('set/set_default',array('addr_id'=>$var['addr_id']));?>">设为默认</a><?php endif; ?>
                             <a class="gozf" href="<?php echo U('set/adressedit',array('addr_id'=>$var['addr_id']));?>">编辑</a>
                              <a target="chuang_frm" class="quxiao" mini="confirm" href="<?php echo U('set/adressdelete',array('addr_id'=>$var['addr_id']));?>">删除</a>
                            </td>
