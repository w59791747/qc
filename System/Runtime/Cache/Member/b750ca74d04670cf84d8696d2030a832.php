...
<div class="uc_mid_r yitou_list">
			<ul class="cz_tit">
				...
				<li class="cz_cur"><a href="<?php echo U('member/set/pwd');?>">支付密码</a></li>
				<li><a href="<?php echo U('member/set/card');?>">绑定银行卡</a></li>
				<li><a href="<?php echo U('member/set/adress');?>">收货地址</a></li>
			</ul>
			<div class="xgzl">
             <form method="post"  action="<?php echo U('set/pwd');?>"  target="chuang_frm">
				<p><span>手机号</span><input readonly="readonly" value="<?php echo ($MEMBER[mobile]); ?>" type="text"  class="mima_box" /><a id="jq_send" class="get_tell">获取验证码</a></p>
...
<script type="text/javascript">
        ...
        $(function () {
            $("#jq_send").click(function () {
                if (mobile_lock == 0) {
                    mobile_lock = 1;
                    $.post("<?php echo U('set/sendsms2');?>",{mobile:$("#mobile").val()},function(data){
