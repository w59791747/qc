...
<div class="user_center">
	...
	<div class="uc_mid">
		...
		<div class="uc_mid_r yitou_list">
			...
			<div class="xgzl rz_cont">
             <?php if($MEMBER["verify"] == 2 || $MEMBER["verify"] == 3 || $MEMBER["verify"] == 6 || $MEMBER["verify"] == 7): ?><p><span>手机认证</span><a href="" class="rz_end">已认证</a></p>
              <?php else: ?>
				<p><span>手机认证</span><a href="<?php echo U('member/set/mobile');?>" class="go_rz sh_false">去认证</a></p><?php endif; ?>
             
                 <?php if($MEMBER["verify"] == 4 || $MEMBER["verify"] == 5 || $MEMBER["verify"] == 6 || $MEMBER["verify"] == 7): ?><p><span>实名认证</span><a href="" class="rz_end">已认证</a></p>
				 <?php else: ?>
				 <p><span>实名认证</span><a href="<?php echo U('member/set/name');?>" class="go_rz">去认证</a></p><?php endif; ?>
