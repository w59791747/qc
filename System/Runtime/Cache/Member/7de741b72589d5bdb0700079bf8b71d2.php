...
<div class="uc_mid_r yitou_list">
			<ul class="cz_tit">
				<li class="cz_cur"><a href="<?php echo U('member/set/index');?>">修改资料</a></li>
             ...
             <form method="post"  action="<?php echo U('set/index');?>"  target="chuang_frm">
                ...
                <p class="sfz">
                  ...
                  <div class="control_txt">
                    <img id="photo_img" width="100px;"  src="__ATTACHS__/<?php echo (($MEMBER["face"])?($MEMBER["face"]):'default.jpg'); ?>" />
				...
				<p><span>生日</span>
                	<select name="data[Y]" class="text sel_year short" rel="<?php echo (($MEMBER["Y"])?($MEMBER["Y"]):'2000'); ?>">
                    </select>
                    &nbsp;年&nbsp;
                    <select name="data[M]" class="text sel_month short" rel="<?php echo (($MEMBER["M"])?($MEMBER["M"]):'2'); ?>">
                    </select>
                    &nbsp;月&nbsp;
                    <select name="data[D]" class="text sel_day short" rel="<?php echo (($MEMBER["D"])?($MEMBER["D"]):'14'); ?>">
                    </select>
                    &nbsp;日&nbsp; </p>
				<p><span>性别</span>女&nbsp; 
              ...
              value="woman" />男</label>
            <label class="radio"> <input type="radio" name="data[gender]" 
              <?php if($MEMBER["gender"] == man): ?>checked="checked"<?php endif; ?>
              value="man" />
                </p>
                 <input type="submit" class="cz_but" value="提交数据">
                 </form>
			</div>
		</div>
		<div style="clear:both"></div>
