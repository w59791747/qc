...
class IndexAction extends CommonAction {
    ...
    public function index() {
        ...
        //file_put_contents('/www/web/bao_zhuchuang_cn/public_html/zhuchuang/Lib/Action/Weixin/aaa.txt', var_export($data, true));
        switch ($data['MsgType']) {//
            case 'event':
    ...
    private function events() {
        ...
        $data['post'] = $_POST;
        $data['data'] = $this->weixin->request();
        //file_put_contents('/www/web/bao_zhuchuang_cn/public_html/zhuchuang/Lib/Action/Weixin/aaa.txt', var_export($data['data'], true));
        if (!empty($data['data'])) {
            ...
            if ($type == 1) {
                ...
                //file_put_contents('/www/web/bao_zhuchuang_cn/public_html/zhuchuang/Lib/Action/Weixin/bbb.txt', var_export($content, true));
    ...
    public function scan() {
        $data['data'] = $this->weixin->request();
        //file_put_contents('/www/web/bao_zhuchuang_cn/public_html/zhuchuang/Lib/Action/Weixin/ccc.txt', var_export($data['data'], true));
        if (!empty($data['data'])) {
            ...
            if ($type == 1) {
                ...
                //file_put_contents('/www/web/bao_zhuchuang_cn/public_html/zhuchuang/Lib/Action/Weixin/aaa.txt', var_export($content, true));
                $result = D('Connect')->getConnectByOpenid('weixin', $data['data']['FromUserName']);
                if (!empty($result)) {
                    $user_id = $result['uid'];
                    if (!$fans = D('Shopfavorites')->where(array('user_id' => $user_id, 'shop_id' =>$tuan['shop_id']))->find()) {
