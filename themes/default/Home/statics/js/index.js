...
$(document).ready(function(){
	...
	$('.news .newswrap div.ph_list ul li').css({background:'url(/themes/default/Home/statics/images/ph4.png) 8px center no-repeat'})
	$('.news .newswrap div.ph_list ul li:eq(0)').css({background:'url(/themes/default/Home/statics/images/ph1.png) 8px center no-repeat'})
	$('.news .newswrap div.ph_list ul li:eq(1)').css({background:'url(/themes/default/Home/statics/images/ph2.png) 8px center no-repeat'})
	$('.news .newswrap div.ph_list ul li:eq(2)').css({background:'url(/themes/default/Home/statics/images/ph3.png) 8px center no-repeat'})



	$('.tslice:eq(0) ul li:eq(0) a').text($('.tslice:eq(0) ul li:eq(0) a').text().substring(0,14)+'…')
	$('.tslice:eq(1) ul li:eq(0) a').text($('.tslice:eq(1) ul li:eq(0) a').text().substring(0,12)+'…')
	for(var i=0;i<$('.itemlist ul li a.list_tit span').length;i++){
		if($('.itemlist ul li a.list_tit span:eq('+i+')').text().length > 20){
			$('.itemlist ul li a.list_tit span:eq('+i+')').text($('.itemlist ul li a.list_tit span:eq('+i+')').text().slice(0,21)+'…');
		}
	}
	...
	if(window.location.href.match('toupiao')){
		$('.item_mid_con .car_con').css({display:'none'});
		$('.item_mid_con .car_vote_con').css({display:'block'});
		$('.item_mid .item_mid_tit ul li a').removeAttr('id');
		$('.item_mid .item_mid_tit ul li a.car_vote').attr('id','cur_item');
	}else{
		return false;
	}
...
/*充值订单*/
	...
	$('.stepzf li').click(function(){
		$('.stepzf li').css({background:'#ffffff',color:'#333333'})
		$(this).css({background:'#DE522E',color:'#ffffff'})
		if($(this).index() == 0){
			$('.xxzf').hide();
			$('.xszf').show();
		}else{
	...
	$('.zffs_cont li').click(function(){
		$('.zffs_cont li').css({border:'1px solid #ededed'});
		$(this).css({border:'1px solid #24C56F'});
	})